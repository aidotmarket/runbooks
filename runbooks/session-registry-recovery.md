---
runbook_id: session-registry-recovery
domain: session-lifecycle
status: DRAFT
authoritative_for:
  - topic: session-registry-recovery
    section: §G. Repair
  - topic: session-number-allocation
    section: §E. Operate
aliases: []
error_signatures:
...
> Phase 2 Chunk A forward-path draft. The root source remains in place. While
> this header says DRAFT, this file is not catalog authority and generated
> catalog surfaces must remain unchanged.
