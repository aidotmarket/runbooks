...
Mars owns the protected environment, payment operations and accepted runtime transition. MP authors product and product tests. Vulcan independently reviews, maintains Workspace integration and runbooks, and does not create a second runtime or mutate a peer checkout. Existing user authority is cumulative up to $100 in real project costs; it does not reset between phases. This covers actual provider/infrastructure charges and authorized real purchases. Nominal Stripe TEST-mode purchase, refund and payout amounts are test ledger values, not real dollars spent; the infrastructure running those tests still counts. The cap alone does not expand the authorized operations.

## Budget source and retained allocation

The user's recorded instruction in the S1712 task is: “I am approving up to 100 dollars on this project, stop stopping.” The exact retained allocation is `outputs/profile-result-wire-run-s1712/SELLER-BOOTSTRAP-BUDGET-REFRESH-S1712.json`, observed September 11 at 16:38:05.921667 UTC in the S1712 workspace. [Budget provenance and interpretation](evidence/seller-refund-access-s1712/SELLER-BUDGET-AUTHORITY-CLARIFICATION-S1712.json) binds its hash and peer clarification Mars4250/Vulcan4252.

The allocation retains $30.7473674546 for earlier provider activity/reservations, adds $4.089578 for two bounded profiling runtimes, then includes $50 for the two earlier real S1707 purchases: $84.8369454546 total reserved exposure. The arithmetic unallocated balance is $15.1630545454. It is not a refreshed billing balance: delayed usage, unused attempts and credits do not automatically release a reservation. Keep this allocation until actual accounting is refreshed before further cost-bearing execution. These historical runtime windows have expired; the receipt cannot authorize a new runtime by replay.

The receipt's `proposed_additional_authority_usd: 65` is a stale proposal field. Its current/proposed cap is 100 and `new_authority_required` is false; the user authorized a cumulative cap of $100, not another $65. Preserve the historical receipt unchanged and apply this interpretation. No new spending, purchase or budget expansion was requested by the clarification.
