...
**CRM** — architecture, pipeline, target state: [crm-architecture.md](crm-architecture.md) · [crm-pipeline.md](crm-pipeline.md) · [crm-target-state.md](crm-target-state.md). Remote MCP connector (Claude.ai) auth — token location, connector-add, rotation, enforce toggle: [crm-architecture.md](crm-architecture.md#crm-remote-mcp-connector-claudeai--auth-s1096).
