...
**Constitution amendment (changing CORE.md)** — unanimous Council gate (CC, DeepSeek, GLM) PLUS Max's direct approval, then the versioned apply to `infra:constitution` + the backend git mirror, boot-delivery verification, drift/marker repair: [constitution-amendment.md](constitution-amendment.md).
