...
For the accepted future lifecycle, `versions.env` at environment `43d67264ab7a3a7e47d6cc6911737273ce1c94cc` pins backend `c3a62af8ccf60929a8e7cec3d62c9d30e0adefd2`; frontend, AIM Data source/image and browser identities in the table remain unchanged. This is a source acceptance record, not a production deployment. **Historical:** the table below records run 25's runtime, which was released on 2026-09-24 (Event 19623e89). The current S1738 environment runs at environment `e99803d` with the pins in its own `versions.env` (backend `5752f26d6f2ac9a9c4eef945f11f14c40eb16ab3`, frontend `cb3d11da161ceb41ab8fe4dab665b072673879d7`).

| Product/runtime | Run 25 identity (historical, released) |
| --- | --- |
| Environment harness | `03d3f30acf854537edd76fdb19e1cf521b577c9a` (PR #35; S1656 A2 item 36 / S1681 G14.22; product pins unchanged) |
| ai-market-backend | `d766b8e4e66d7803ebe48f8a3132521abbebe957` (post-Chunk-A `5cedc41f` plus [backend PR #371](https://github.com/aidotmarket/ai-market-backend/pull/371), VZ publish versions response, plus [backend PR #374](https://github.com/aidotmarket/ai-market-backend/pull/374), G14 `verification-artifact` route, plus [backend PR #380](https://github.com/aidotmarket/ai-market-backend/pull/380), Trust-Channel expired-device fix, Seller Workspace PRs #375–#379 with Alembic 20260910_002/_003, [backend PR #392](https://github.com/aidotmarket/ai-market-backend/pull/392), G14 route retry on STS `AccessDenied`, Seller Workspace W3 profiling PRs #384–#391 and #393, and [backend PR #394](https://github.com/aidotmarket/ai-market-backend/pull/394), retryable checkpoint before the `payment_intent.succeeded` async boundary, and [backend PR #395](https://github.com/aidotmarket/ai-market-backend/pull/395), device acks mark outbound fulfillment requests delivered; previously `ec5262cf25ac46cf6ba437457572f587df375ac3`) |
| ai-market-frontend | `ffd54077bf115bbcb09882150c37f17ce4c672d5` (post-[frontend PR #65](https://github.com/aidotmarket/ai-market-frontend/pull/65), login redirect preserves the query string; includes Seller Workspace frontend work; previously `943429b586fa4acd55f81f23ded5005cbcf841e1` |
| AIM Data source | `51e2740f6972c008626e186d8b265601c58eca32` (v1.23.3-rc.2, [aim-data PR #59](https://github.com/aidotmarket/aim-data/pull/59) S3-provenance fix) |
| AIM Data image | `v1.23.3-rc.2@sha256:67fd600590e2608c2019cef6f802488bd04ed69474b896c803e878c352c55925` (stable release tags are accepted; the digest is mandatory) |
| Browser runner | Playwright `1.61.0`, Chromium revision `1228`, browser `149.0.7827.0` |

The final head after S1709 was `e2028111f66d2b95d0c361d2c888b549b16520f8` (environment PRs #10/#11/#12); after the S1710 G9 IAM transport fold ([PR #13](https://github.com/aidotmarket/money-path-test-environment/pull/13), S1656 A2 item 15, S1681 Amendment G10) it was `f3ffcd4895825f0c0981a45f43e40e86722db648`; after the S1710 trust-propagation fold ([PR #14](https://github.com/aidotmarket/money-path-test-environment/pull/14), S1656 A2 item 16, S1681 Amendment G11) it was `6a1cfcfa5fc39f88a78ee5e15b1cff5f67ae0aa5`; after the S1710 AIM Data v1.23.3-rc.2 repin ([PR #15](https://github.com/aidotmarket/money-path-test-environment/pull/15), S1656 A2 item 17, S1681 Amendment G12) it was `1674ffde6cea37484ef11801885d8312df369ff1`; after the S1710 backend repin ([PR #16](https://github.com/aidotmarket/money-path-test-environment/pull/16), S1656 A2 item 18, S1681 Amendment G13) it was `edcab6de9dd918addd59b1404273f628c0f8338e`; after the S1711 G14 backend repin ([PR #17](https://github.com/aidotmarket/money-path-test-environment/pull/17), S1656 A2 item 19, S1681 Amendment G14.7) it was `c594010726367f7f1513f6c1b7fb478f0c45f9af`; after the S1711 scan-propagation and evidence-query fix ([PR #18](https://github.com/aidotmarket/money-path-test-environment/pull/18), S1656 A2 item 20, S1681 G14.8) it was `6abc612c45f3e5fb89960cd2c79adc1327506c6f`; after the S1711 hosted-Checkout wait fix ([PR #19](https://github.com/aidotmarket/money-path-test-environment/pull/19), S1656 A2 item 21, S1681 G14.9) it was `c22f4cbcda24f924037038b17cf28afa5bf6ed86`; after the S1711 unpaid-checkpoint release command ([PR #20](https://github.com/aidotmarket/money-path-test-environment/pull/20), S1656 A2 item 22, S1681 G14.10) it was `f82da31f06a2e2da4c3fa79128a66ca5adf14110`; after the provider-scoped payment proof ([PR #21](https://github.com/aidotmarket/money-path-test-environment/pull/21), S1656 A2 item 23, S1681 G14.11) it was `0ce89ab8a22787eea474f3beefdea0f54a10ae89`; after the Stripe-object fix ([PR #22](https://github.com/aidotmarket/money-path-test-environment/pull/22), S1656 A2 item 24, S1681 G14.12) it was `031d67e6053dc368bf26d63df6dbe1af37735631`; after the backend repin to `be28ae3e382bcbb07a62594037e0595d8f189238` ([PR #23](https://github.com/aidotmarket/money-path-test-environment/pull/23), S1656 A2 item 25, S1681 G14.13) it was `7caf73ce2123b4ea8c5c06e2dfb996317ceb2376`; after the G15 refund-and-release command ([PR #24](https://github.com/aidotmarket/money-path-test-environment/pull/24), S1656 A2 item 26, S1681 G15.7) it was `454a6f84d0d0b4a2aa507cfc5a20cfa501180e94`; after the synthetic-scope release binding ([PR #25](https://github.com/aidotmarket/money-path-test-environment/pull/25), S1656 A2 item 27, S1681 G15.10) it was `f9dc9497b2d19c451bd754a0ec1e5f37bfc88a63`; after the frontend repin to `ffd54077bf115bbcb09882150c37f17ce4c672d5` ([PR #26](https://github.com/aidotmarket/money-path-test-environment/pull/26), S1656 A2 item 28, S1681 G14.14) it was `dedb159b1a10df4ad1ffba4b40f871c1f4ef2132`; after the Docker-API-load hardening ([PR #28](https://github.com/aidotmarket/money-path-test-environment/pull/28), S1656 A2 item 29, S1681 G14.15) it was `e69a76120559b4a8def8db122ce7f3a09af0386d`; after the backend repin to the STS `AccessDenied` retry ([PR #29](https://github.com/aidotmarket/money-path-test-environment/pull/29), S1656 A2 item 30, S1681 G14.16) it was `e19baeb72c8b0b3851736f30c743e45d833fdb50`; after the backend repin to the payment-webhook checkpoint ([PR #30](https://github.com/aidotmarket/money-path-test-environment/pull/30), S1656 A2 item 31, S1681 G14.17) it was `ce9506ca02d1b1c29a5045215567d18d688a481b`; after the seed register-step retry ([PR #31](https://github.com/aidotmarket/money-path-test-environment/pull/31), S1656 A2 item 32, S1681 G14.18) it was `78561d1d9998cef07677e428a8431468507a4360`; after the backend repin to the Trust Channel ack fix plus the acknowledged-request assertion ([PR #32](https://github.com/aidotmarket/money-path-test-environment/pull/32), S1656 A2 item 33, S1681 G14.19) it was `46c43a0969ffc1d5bb6817edca17391fbe5ecee7`; after the fresh direct-Docker polling and device-retry fix ([PR #33](https://github.com/aidotmarket/money-path-test-environment/pull/33), S1656 A2 item 34, S1681 G14.20) it was `6c953f0e1152c1dee21d3fd80302e42a11972d1b`; after the standalone replay model-registration fix ([PR #34](https://github.com/aidotmarket/money-path-test-environment/pull/34), S1656 A2 item 35 / S1681 G14.21) it was `31627993cc158f230df5a48b1b9c3ac84c595ce4`; after the hosted-return bounded-wait correction ([PR #35](https://github.com/aidotmarket/money-path-test-environment/pull/35), S1656 A2 item 36 / S1681 G14.22) it was `03d3f30acf854537edd76fdb19e1cf521b577c9a`. After the accepted refund-safe environment ([PR #36](https://github.com/aidotmarket/money-path-test-environment/pull/36), S1656 A2 item 37 / S1681 G14.23), the accepted final head is `43d67264ab7a3a7e47d6cc6911737273ce1c94cc`, with backend `c3a62af8ccf60929a8e7cec3d62c9d30e0adefd2`. The historical records above retain their own source identities.

After this documentation PR merges, its full merge commit will identify both `S1656_SPEC_A2_SHA` and `S1681_SPEC_SHA` for that future accepted environment; a document cannot embed its own merge commit. Make that commit available in `S1656_RUNBOOKS_REPO` before verification. (Historical: while run 25 was protected the instruction was the following; it no longer applies.) **Do not update `/Users/max/koskadeux-state/s1656/nightly-pins.env` or run 25's source checkout now.** Apply new runtime pins only after the protected lifecycle permits the transition. At that point require a clean checkout at the accepted environment head and `rtk proxy ./bin/check-settlement --pins` exit 0 with both new pins exported. The accepted checker's `pins()` requires each spec's literal final-head record, backend/AIM Data source and full image value; S1681 also requires G9 and ancestry from `08d8433d3564b23353c800b1a0cd4a32874478fb`. Missing, malformed, nonexistent or stale pins refuse; verification never fetches. The accepted v2 procedure additionally binds immutable phase receipts and retains the genuine settlement, refund, scheduled-run and production gates.
...
### G.2 S1738 licence journey: live operation notes (2026-09-24/25)
...
- **Synthetic purchases need an armed window.** buyer-02 buying from seller-01 is a synthetic pair; backend `transaction_service.py:367` refuses it with 403 `synthetic_purchase_requires_e2e_guard` unless `E2E_ARMED_AT` is within `E2E_MAX_ARMED_WINDOW_MINUTES` (default 15). Compose has no passthrough for `E2E_ARMED_AT`; S1738 used a private override file outside Git for one window (Event c9fad554) and recreated the backend without it afterwards. Record every arming in the Event Ledger.
- **Synthetic purchases are mock-paid.** At this backend a synthetic pair takes the mock path (`cs_e2e_mock_*`, `pi_e2e_mock_*`; the order goes straight to `delivered`); there is no hosted Stripe page and nothing in Stripe to refund. The buyer-standard Playwright phase, which expects `checkout.stripe.com`, fails at the checkout URL for this pair. A Stripe-refund proof needs a non-mock purchase.
- **Frontend rewrites** (`/licenses/*`, `/llms.txt`, `/requests.txt`, `/.well-known/*`, `/l/:code/card.png`) are proxied server-side to `NEXT_PUBLIC_API_URL=http://localhost:18000`; PR #52 adds an in-container forwarder so that works. Check with `curl -s -o /dev/null -w '%{http_code}' 'http://127.0.0.1:13000/licenses/standard/1.0/ai-training?download=1'` (expect 200).
- **Agent routes need an agent key.** `/api/v1/agent/*` is guarded by `AgentAuthMiddleware` (backend `app/main.py:797-799`) and needs an `agent_api_keys` key in `X-API-Key`; the handlers also need an OAuth bearer. A user API key from `/settings/api-keys` returns 401 `Invalid agent API key`. No product route issues agent keys (Event 9e322a2c), so agent-purchase and the agent doors cannot run until one exists. Do not insert keys by hand.
- **Door probe** (`workspace/license-doors.py` at `e99803d`): the in-container inventory import takes about 30 s (PR #51 raised the timeout to 180 s), but at this head the tool cannot complete for a Workspace web order: the app logs to stdout, which breaks its inventory parsing, and it requires every generated route to succeed before refund, which only the Workspace download/session/file routes and the deliveries token/download-url routes can. Environment PR #53 (merged as `736c291`) adds marker parsing, the backend-SHA label check and exact pinned per-route design refusals; use a head containing it. Even then `before`/`after` cannot complete until buyer-02 has an agent key and agent OAuth bearer for the three agent doors (see the agent-routes bullet). An order allows three downloads and three delivery-token attempts, so budget probes accordingly.
- **Playwright** failure context includes request headers with bearer tokens. Since environment PR #56 the licence config refuses `--output`, `--reporter`, `--last-failed-file`, `--trace` and reporter/output environment overrides, and requires `S1738_PLAYWRIGHT_OUTPUT_DIR`: an absolute, empty, current-user-owned directory with mode `0700`, outside the repository and not an ancestor of it, whose parent is not world-writable. Create a fresh one per run and delete it afterwards.
...
| --- | --- | --- | --- |
| Verification epoch goes `AUTHORIZED` then `FAILED_VOIDED` within seconds and the backend log shows `POST /api/v1/serials/{serial}/s3-connections/verification-artifact → 404` | Backend candidate predates [backend PR #374](https://github.com/aidotmarket/ai-market-backend/pull/374) (`31f09b5666314aa375d41d269be52552d518ba94`), so AIM Data's opaque-handle artifact fetch has no receiver | Repin `BACKEND_RC_SHA` to a backend containing `c673eafd` and rerun from clean seed; never fall back to `presign-object` with local connection details (S1681 G14.1 Option B is rejected) | `docker compose --env-file versions.env logs backend \| grep verification-artifact`; `grep BACKEND_RC_SHA versions.env` |
| `seed: host handoff failed (details suppressed)` after the container seed printed `status: seeded`, with `.state/s1681-seed.json` showing `connection_id` and `external_id_sha256` but no `scan_id`/`dataset_id`, and aim-data-postgres `s3_scan_job` holding a `failed` row with `error_message: assume_role:AccessDenied` seconds after a successful verify | IAM trust-policy propagation flapped between the verify and the scan (run 7) | Run only at an environment head that includes PR #18 (scan resubmission loop); if it still fails after 120 s the trust document itself is wrong — inspect it read-only, do not reissue the serial | `docker exec ai-market-money-path-s1656-aim-data-postgres-1 psql -U aim_data -d aim_data -Atc "select status,error_message from s3_scan_job"` |
| `seed: host handoff failed (details suppressed)` after `status: seeded`, with `.state/s1681-seed.json` showing `connection_id` and `external_id_sha256` but no `scan_id`/`dataset_id`, aim-data-postgres `s3_scan_job` `completed` with `objects_enumerated` 1 and `s3_object_metadata` holding the run object with `dataset_id` NULL, and the backend access log ending at a `presign-object` 200 | AIM Data's register route failed right after the presign (run 19): the same IAM/STS propagation flap, at the register step | Run only at an environment head that includes PR #31 (register retry loop); if it still fails after 120 s, inspect the trust document read-only and the AIM Data route (its error is unlogged — T-2026-000782) | `docker exec ai-market-money-path-s1656-aim-data-postgres-1 psql -U aim_data -d aim_data -Atc "select object_key,dataset_id from s3_object_metadata; select count(*) from dataset_records"` |
| Browser fails at `S1681 refusal: independent observation or device operation` on the first `deliveryLeg` bridge call | The `bin/verify` evidence helper on 127.0.0.1:18003 answered 503 because `delivery_snapshot()` raised; below PR #18 the AIM Data query named the non-existent table `s3_connections` | Run at a head including PR #18; to see the underlying error run the two evidence SQL blocks by hand under the Infisical test-env (see §H) | `bin/check-settlement` `delivery_snapshot()`; `browser/s1681-delivery-leg.ts:29` |
| Browser fails `delivery: hosted checkout interaction failed` after `payment-arm` | The delivery leg's hosted Stripe Checkout interaction did not reach the localhost redirect within 90 s; below PR #19 the email field was read before the page rendered. Reproduce with a diagnostic Playwright pass inside the browser-runner that logs each locator step with URLs redacted and stops before Pay (see `money-path-proof-loop.md` §C) | Run at a head including PR #19; if it recurs, compare the locators with `completeHostedSetup` in `browser/s1590-money-path.spec.ts` | backend access log around `POST /api/v1/checkout/create`; `stripe_events` for the order's `checkout.session.completed` |
| Browser fails `return from hosted setup did not reach readiness ready` on the second (return-first) card setup | Frontend return page mounted without the re-authentication dialog (intermittent; `s1590-money-path.spec.ts:601–611`); the attempt stays `open` | Root-caused in S1711 (runs 9 and 13): a refresh-token 401 on the return sent the seller through `/login?redirect=<pathname only>` and the query was lost. Run at a frontend containing PR #65 (`ffd54077` or later). If it recurs there, check the backend log for `auth/refresh … 401` followed by `auth/login`, and whether the redirect kept `?attempt=&session_id=` | `select id,state,last_reconciled_at from data_verification_payin_setup_attempt order by created_at desc limit 2` in the backend database |
| `bin/verify --from-clean-seed` exits within a minute with `s1681: refused or failed (details suppressed); preserve active run` and `active-run.json` shows `state: purchasing` | A previous run wrote the purchase checkpoint (`begin_purchase`) and failed before paying; the guard refuses every mutation | Prove no money: every buyer-01/seller-01 order `created`/`checkout_pending`, no PaymentIntent, no payment event, no transfer. Then release with `rtk proxy python3 bin/check-settlement --abandon-unpaid <run_id> <environment_sha40> [<order_uuid> ...]` (run id and historical head from `active-run.json`; name every order if more than one). It expires the Checkout Sessions at Stripe and refuses on any provider-side payment evidence (paid session, or a PaymentIntent beyond requires_payment_method/canceled). Export both acceptance pins and run it under the Infisical test-env (`infisical run --projectId=bd272d48-… --env=test-env --`), not bare `rtk proxy`, or it refuses on the missing pins/compose variables. Never edit `active-run.json` by hand | `cat /Users/max/koskadeux-state/s1656/acceptance-evidence/active-run.json`; backend DB `select id,status,stripe_payment_intent_id from orders order by created_at desc`; `<run>/<phase>/abandoned.json` afterwards |
| Browser fails `S1681 observation deadline exceeded` at `s1681-delivery-leg.ts:133` after the order reached `delivered`; backend log shows repeated `Unexpected Trust Channel error: greenlet_spawn has not been called` and `Replacing existing trust channel session` every few seconds | Backend predates PR #380: a rollback in the fulfillment dispatch expired the device row and the next frame crashed the socket | Run at a backend containing PR #380 (`be28ae3e` or later) | `docker logs ai-market-money-path-s1656-backend-1 \| grep -c MissingGreenlet` |
| Browser fails `S1681 observation deadline exceeded` at `s1681-delivery-leg.ts:133` during the provider-event redelivery check, the proxy log shows one `POST /api/v1/webhooks/stripe` answered `504` after ~60 s, and the backend log shows `payment_intent.succeeded … "processing_ms": 60xxx` (Postgres: `canceling statement due to user request … ix_stripe_events_stripe_event_id`) | Backend predates PR #394: the webhook's uncommitted dedup row and BillingService's insert of the same `stripe_event_id` on a second session block each other until the proxy timeout | Run at a backend containing PR #394 (`ec5262cf` or later); release the paid checkpoint with `--abandon-refunded` first | `docker logs ai-market-money-path-s1656-backend-1 \| grep -o '"event_type": "payment_intent.succeeded".*"processing_ms": [0-9]*'` |
| Browser fails `S1681 refusal: single acknowledged fulfillment request`, or the AIM Data log shows `Fulfillment request enqueued` repeating for one order and `Trust Channel rate limited`, with `trust_outbound_messages.attempt_count` in the thousands and `acked_at` NULL | Backend predates PR #395: device acks never mark the outbound `fulfillment_request` delivered, so the ack handler's drain re-sends it at network speed | Run at a backend containing PR #395 (`d766b8e4` or later); release the paid checkpoint with `--abandon-refunded` first; stop the device container to end a live storm | `docker exec ai-market-money-path-s1656-postgres-1 sh -c 'psql -U "$POSTGRES_USER" -d "$POSTGRES_DB" -Atc "select status,attempt_count,acked_at from trust_outbound_messages where message_type='"'"'fulfillment_request'"'"'"'` |
| Every run exits with `preserve active run`; `active-run.json` says `purchasing`, and the order is `paid`/`delivered` with a PaymentIntent but no Transfer | The proof failed after the buyer paid; money is in flight, `--abandon-unpaid` correctly refuses | After proving no Transfer/settlement (`transfer_id`, `settled_at`, `payout_triggered_at` null): `python3 bin/check-settlement --abandon-refunded <run_id> <environment_sha40> <order_uuid>` under the Infisical test-env with both pins exported (S1681 G15). It refunds the buyer in full at Stripe, waits for the product to record that refund's own `charge.refunded` event (for synthetic buyers the product deliberately suppresses the refund handler and stores the event as `e2e_scope_suppressed`; the order stays `delivered` — that is expected), then releases the checkpoint. Never settle a run whose proof failed | `<run>/<phase>/refunded-abandoned.json`; backend DB `select status, revoked from orders where id=…` |
| Browser fails with `fetch failed … ConnectTimeoutError … host.docker.internal:18003`, or `S1681 refusal: independent observation or device operation` right after a `device-stop`/`device-start`, with the order already `delivered` and no product error in the backend log | Docker Desktop API starved: too little VM memory, hundreds of stale containers, or heavy `docker compose exec` churn | Check `docker info --format '{{{{.MemTotal}}}}'` (≥ 24 GiB expected), `docker ps -a \| grep -c Exited` (prune with Max's approval), and Docker's host log `~/Library/Containers/com.docker.docker/Data/log/host/com.docker.backend.log` for `ContainerStop` without a matching container event. Release the paid checkpoint with `--abandon-refunded` and rerun; do not add a snapshot cache to the helper (G14.15) | Docker host log; `docker events --since … --filter container=…aim-data-1` |
| `compose-contract: FAIL: missing: live Stripe secret-key prefix refused before network access` printed by `./bin/up` itself (test-env holds only test keys; `./tests/compose-contract.sh` run on its own passes) | Known in-up contract defect (Event 0ae5cd16): the contract's stubbed `preflight --pure` live-prefix probe fails when run from `bin/up` with the lifecycle environment exported (seen 2026-09-24 and 2026-09-25, both with `S1738_WORKSPACE_OVERLAY=true`) | Run `./tests/compose-contract.sh` alone from the same clean checkout; only if it prints `compose-contract: PASS`, rerun `./bin/up` in the same shell with `S1656_CONTRACT_RUNNING=true` added to the exported lifecycle variables (the switch `bin/up` already honours to skip the in-up contract run). Record both logs in the Event Ledger. Do not use the switch without a standalone PASS from that exact head | `/Users/max/koskadeux-state/s1656/logs/`; Events 0ae5cd16, 453c9a4d |
...
| `down: Cloudflare token re-read returned an unexpected state`, preceded by `s1681: refused or failed (details suppressed); preserve active run`, with empty `token-read.json` and `token-read.http-status` in the new teardown-evidence directory | Environment below PR #45: `admin_request` re-invokes `bin/down --admin-request` under `env -i`, which drops `S1681_LOCK_ENTERED`, so the child tries to take the lock its own parent holds (S1738, Event 11daad95). `bin/down` could not complete from bdfce67 (2026-09-09) until PR #45 | Nothing was mutated (it stops at the token re-read). Run `down` at an environment head containing PR #45; the freshly minted narrow token stays valid for 24 hours | `/Users/max/koskadeux-state/s1656/logs/s1738-teardown-*.log`; `/Users/max/koskadeux-state/s1656/teardown-evidence/<UTC-run-stamp>/token-read.json` |
| `bin/down` or `bin/reset` stops with `s3-fixture: refused or failed; inspect run ownership and required test-env configuration (provider details suppressed)` while `active-run.json` is a v1 `settled` online checkpoint from an older environment head | `seed/s3-fixture.py cleanup` refuses a settled checkpoint whose recorded source differs from the current head's pins ("unresolved active run cleanup refused"). A settled online-only checkpoint only leaves `settled` through the concluding two-phase verify | If the owner has decided the run will not be concluded (e.g. Event 19623e89 for run 25), retire it once with `bin/check-settlement --retire-settled <run_id> <environment_sha40> <decision_event_uuid>` (environment PR #46) under the Infisical test-env with both acceptance pins exported, then rerun `down`. It proves one settled transfer and no pending work, deletes only the journalled S3 object, writes `cleanup.json` and `retired.json` (`full_acceptance_pass: false`) and archives the checkpoint as `<run>/active-run.retired.json`. It is resumable; re-run the same command after any interruption. Never edit or move `active-run.json` by hand | `<run>/online/retired.json`; `<run>/active-run.retired.json` |
| 403 `synthetic_purchase_requires_e2e_guard` on `POST /api/v1/checkout/create` for buyer-02 / seller-01 | Synthetic pair outside an armed E2E window (backend `transaction_service.py:367`) | Arm one window as in G.2 (private override, Event Ledger record), buy within 15 minutes, then disarm with `bin/recreate backend` without the override, or escalate; never a raw compose recreate | G.2; `docker exec ai-market-money-path-s1656-backend-1 sh -c 'echo $E2E_ARMED_AT'` |
| Frontend log `Failed to proxy http://localhost:18000/api/v1/licenses/... ECONNREFUSED`; full-licence link returns 500 | Next rewrites proxied inside the frontend container to host localhost (environment below PR #52) | Bring the checkout to a head containing PR #52, then `bin/recreate frontend`; never a raw compose recreate | G.2 curl check |
| `database cardinality result incomplete` or `read-only order proof failed` from `license-db-snapshot.py` | Environment below PR #54: multi-statement SQL sent with `psql -c`, which prints only the last result | Run at an environment head containing PR #54 | `workspace/license-db-snapshot.py` |
| 401 `x-api-key header is required` or `Invalid agent API key` on `/api/v1/agent/*` | Agent routes need an `agent_api_keys` key plus an OAuth bearer; a user API key is not an agent key | No product route issues agent keys (Event 9e322a2c); do not insert keys by hand; wait for the owner decision | G.2 |
...
| `device-start` helper non-OK after successful delivery/download while Docker CLI hangs | Run 22: per-second Compose polling repeatedly interpolated the full environment and loaded Docker Desktop | Use PR #33 or later: fresh exact project/service IDs, direct Docker SQL/log reads, stopped-device lookup and three bounded action attempts. No snapshot cache. If a paid run fails, use the documented `--abandon-refunded` command before rerunning; diagnose product defects in their owning repo | `bin/check-settlement:219–308,523–548`; S1656 A2 item 34 / S1681 G14.20; run 22 refund receipt `20260911T205903Z/online/refunded-abandoned.json` |
| `redeliver-refresh` helper non-OK at browser line 228; read-only ORM probe raises `InvalidRequestError` for `S3ScanJob` | Standalone replay process imported S3Connection but omitted its string relationship target; restart and the first refresh may already have passed | Use PR #34 model-registration import; reproduce with imports plus read-only `select(FulfillmentLog)` before any retry. Release a failed paid run using G15 first. Check current source line labels, not stale handoff labels | S1656 A2 item 35 / S1681 G14.21; `bin/check-settlement:570–595`; run23 refund receipt |
| `return from hosted setup did not reach readiness ready` before payment | Run24 had an open second setup attempt and no return/reconcile event. Three harness `isVisible(timeout)` probes did not wait for asynchronous dialog hydration; exact failed-run cause remains open | Use PR #35 real bounded waits, preserve genuine login/reconcile/readiness assertions, and inspect new evidence. Confirm absence of payment/checkpoint before clean rerun; respect serial issuance budget. If a product defect remains, return it to its owner | S1656 A2 item 36 / S1681 G14.22; run24 log; `browser/s1590-money-path.spec.ts` `completeHostedSetup` |
