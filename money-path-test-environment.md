...
| --- | --- |
| ai-market-backend | `ec5262cf25ac46cf6ba437457572f587df375ac3` (post-Chunk-A `5cedc41f` plus [backend PR #371](https://github.com/aidotmarket/ai-market-backend/pull/371), VZ publish versions response, plus [backend PR #374](https://github.com/aidotmarket/ai-market-backend/pull/374), G14 `verification-artifact` route, plus [backend PR #380](https://github.com/aidotmarket/ai-market-backend/pull/380), Trust-Channel expired-device fix, Seller Workspace PRs #375–#379 with Alembic 20260910_002/_003, [backend PR #392](https://github.com/aidotmarket/ai-market-backend/pull/392), G14 route retry on STS `AccessDenied`, Seller Workspace W3 profiling PRs #384–#391 and #393, and [backend PR #394](https://github.com/aidotmarket/ai-market-backend/pull/394), retryable checkpoint before the `payment_intent.succeeded` async boundary; previously `38551add3736838b0d06116b387c06b7af011852`) |
