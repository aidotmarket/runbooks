...
Product defects found and fixed in production by this step (all Council-unanimous): empty-database migration replay (d9dddd5a), install-action digest claim name (353246fa), low-occupancy fingerprint null aggregates (bbce5669), and the Gemini SDK floor for Express keys and response-id metering (in review).
