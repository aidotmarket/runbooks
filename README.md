...
| # | Process | File | Status |
|---|---------|------|--------|
| 1 | [Gmail Drop Pipeline](gmail-drop-pipeline.md) | `gmail-drop-pipeline.md` | Built S222, needs Pub/Sub verification |
...
| 5 | [Session Lifecycle](session-lifecycle.md) | `session-lifecycle.md` | Operational |
| 6 | [Email Drafting](email-drafting.md) | `email-drafting.md` | Operational |
| 7 | [Agent Dispatch](agent-dispatch.md) | `agent-dispatch.md` | Operational |
