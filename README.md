...
| `gate-specification-authoring` | `council-operations` | [`runbooks/gate-specification-authoring.md`](runbooks/gate-specification-authoring.md) | `gate-specification-authoring` → [§C. Architecture & Interactions](runbooks/gate-specification-authoring.md#c-architecture--interactions) | vulcan | 2026-07-26 |
