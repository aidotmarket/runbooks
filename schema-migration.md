...
Revisions to this page land in `aidotmarket/runbooks`; database implementation lands in `aidotmarket/ai-market-backend`. Payment- or customer-data-adjacent migration changes require the complete unanimous GLM/DeepSeek/Gemini Council review before merge or deployment.
